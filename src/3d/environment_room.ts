...
export class EnvironmentRoom extends Environment {
    private static FLOOR_UV_SCALE = 0.4;
    ...
    setRoomWidth(width: number): void {
        ...
        const uScaleFactor = width * EnvironmentRoom.FLOOR_UV_SCALE;
    ...
    setRoomDepth(depth: number): void {
        ...
        const vScaleFactor = depth * EnvironmentRoom.FLOOR_UV_SCALE;
